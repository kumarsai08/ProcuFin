...
export default class DeliveryInformation extends LightningElement {
    //  result;
    //  resultnumber;
    value ;
    @api productrecord;
...
hideModalBox(){
 ...
 createAsset({prodId : this.prodId,batchNumbers : this.batchNumberList, orderid : this.productrecord }).then(result=>{
     this.prodId=''
     this.quanti=0;
